 ...
 * @returns 'light' | 'dark'
 */
function detectThemeFromDOM(): 'light' | 'dark' {
 ...
 */
export function useThemeMode(setupConfig: ResolvedPaymentWidgetConfig | null | undefined): 'light' | 'dark' {
  ...
  const [detectedMode, setDetectedMode] = useState<'light' | 'dark'>(() => {
