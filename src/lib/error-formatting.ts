...
type ErrorFormatter = (matches: RegExpExecArray) => string;

const ERROR_PATTERNS: Array<{ pattern: RegExp; format: ErrorFormatter }> = [
  {
...
const ERROR_SHORTCUTS: Array<{ pattern: RegExp; label: string }> = [
