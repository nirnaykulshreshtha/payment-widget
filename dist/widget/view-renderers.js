...
export function renderPaymentView(config) {
    ...
    switch (view.name) {
        ...
        case 'details':
            if (!selectedOption) {
                return (_jsxs("div", { className: "rounded-2xl border border-dashed border-border/60 bg-card/30 p-6 text-center", children: [_jsx("h3", { className: "text-sm font-semibold", children: "No payment selected" }), _jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: "Choose a payment option to review the details." }), _jsx(Button, { variant: "outline", size: "sm", className: "mt-4", onClick: onResetToOptions, children: "Back to options" })] }));
            }
