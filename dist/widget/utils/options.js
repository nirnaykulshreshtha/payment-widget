 ...
 */
export const getModePriority = (mode) => {
 ...
 */
export const getOptionKey = (option) => `${option.id}:${option.mode}:${option.requiresWrap ? 'wrap' : 'nowrap'}`;
/**
 ...
 */
export const getOptionGroupKey = (option) => {
 ...
 */
export const filterOptionsByPriority = (options) => {
