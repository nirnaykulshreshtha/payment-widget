 ...
 */
export function RelativeTime({ timestamp, className, showTooltip = true, updateInterval }) {
    ...
    const timeElement = (_jsx("time", { className: className, title: showTooltip ? absoluteTime : undefined, dateTime: isoTime, "aria-label": absoluteTime, children: displayTime }));
    return timeElement;
}
