...
export function WidgetHeader({ customComponent, title, subtitle, onBack, onHistory, onRefresh, isRefreshing }) {
    ...
    return (_jsxs("div", { className: "pw-header", children: [_jsxs("div", { className: cn('pw-header__title-wrap', onBack && 'pw-header__title-wrap--with-back'), children: [onBack && (_jsx(Button, { variant: "outline", size: "icon", className: "pw-header__icon-button", onClick: onBack, children: _jsx(ArrowLeft, { className: "pw-icon" }) })), _jsx("div", { className: "pw-header__text", children: customComponent ? (customComponent) : (_jsxs(_Fragment, { children: [_jsx("h2", { className: "pw-header__title", children: title }), subtitle && _jsx("p", { className: "pw-header__subtitle", children: subtitle })] })) })] }), _jsxs("div", { className: "pw-header__actions", children: [onRefresh && (_jsx(Button, { variant: "outline", size: "icon", className: "pw-header__icon-button", onClick: onRefresh, disabled: isRefreshing, children: _jsx(RefreshCw, { className: cn('pw-icon', isRefreshing && 'pw-icon--spinning') }) })), onHistory && (_jsx(Button, { variant: "outline", size: "icon", className: "pw-header__icon-button", onClick: onHistory, children: _jsx(HistoryIcon, { className: "pw-icon" }) }))] })] }));
}
