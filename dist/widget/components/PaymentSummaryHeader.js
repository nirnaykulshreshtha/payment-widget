...
export function PaymentSummaryHeader({ targetAmountLabel, targetSymbol, targetChainLabel, sourceChainLabel, targetChainLogoUrl, sourceChainLogoUrl, lastUpdated, onRefresh, isRefreshing, onViewHistory, onBack, showRefresh = true, showHistory = true, showBack = false, backLabel, showPrimary = true, showTimestamp = true, title, primaryEyebrowLabel = 'YOU NEED TO PAY', }) {
    ...
    if (showPrimary)
        sectionLabelSegments.push(primaryHeadingId);
    if (hasTitle)
        sectionLabelSegments.push(titleHeadingId);
