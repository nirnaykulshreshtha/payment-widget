...
export function PaymentResultView({ type, reference, reason, summary, historyId, onClose, onRetry, onViewTracking }) {
    ...
    return (_jsxs("div", { className: "pw-view pw-view--results", children: [_jsxs("div", { className: cn('pw-alert', isSuccess
                    ? 'pw-alert--success'
                    : 'pw-alert--failure'), children: [_jsxs("div", { className: "pw-alert__icon-wrapper", children: [isSuccess && (_jsxs(_Fragment, { children: [_jsx("span", { className: "pw-alert__ripple pw-alert__ripple--1", "aria-hidden": "true" }), _jsx("span", { className: "pw-alert__ripple pw-alert__ripple--2", "aria-hidden": "true" }), _jsx("span", { className: "pw-alert__ripple pw-alert__ripple--3", "aria-hidden": "true" })] })), isSuccess ? _jsx(CheckCircle2, { className: "pw-alert__icon" }) : _jsx(XCircle, { className: "pw-alert__icon" })] }), _jsxs("div", { className: "pw-alert__body", children: [_jsx("p", { className: "pw-alert__title", children: headline }), _jsx("p", { className: "pw-alert__subtitle", children: subline })] })] }), summary ? (_jsxs("div", { className: "pw-details-card", children: [summary.approvalTxHashes && summary.approvalTxHashes.length > 0 && (_jsx(DetailRow, { label: "Approval transactions", value: renderHashWithOverflow(summary.approvalTxHashes, summary.originChainId ?? summary.input.token.chainId) })), summary.swapTxHash && (_jsx(DetailRow, { label: "Swap transaction", value: renderHashLink(summary.swapTxHash, summary.originChainId ?? summary.input.token.chainId) })), summary.depositTxHash && summary.mode !== 'swap' && (_jsx(DetailRow, { label: summary.mode === 'bridge' ? 'Deposit transaction' : 'Payment transaction', value: renderHashLink(summary.depositTxHash, summary.originChainId ?? summary.input.token.chainId) })), summary.fillTxHash && (_jsx(DetailRow, { label: "Delivery transaction", value: renderHashLink(summary.fillTxHash, summary.destinationChainId ?? summary.input.token.chainId) }))] })) : (_jsxs("div", { className: "pw-details-card", children: [_jsx(Skeleton, { className: "payment-skeleton" }), _jsx(Skeleton, { className: "payment-skeleton" }), _jsx(Skeleton, { className: "payment-skeleton" })] })), _jsxs("div", { className: "grid gap-2", children: [isSuccess && onViewTracking && (_jsx(Button, { variant: "primary", className: "pw-button--full", onClick: onViewTracking, children: "View tracking" })), !isSuccess && onRetry && (_jsx(Button, { variant: "primary", className: "pw-button--full", onClick: onRetry, children: "Try again" })), _jsx(Button, { variant: "outline", className: "pw-button--full", onClick: onClose, children: "Back to options" })] }), reference && (_jsxs("p", { className: "pw-reference", children: ["Reference: ", reference] }))] }));
}
