...
export declare function getNetworkConfig(isTestnet?: boolean): {
    chains: ChainConfig[];
};
export declare function buildViemChain(chain: ChainConfig): Chain;
export declare function createPublicClientFor(chain: ChainConfig): {
    account: undefined;
    batch?: {
    ...
    extend: <const client extends {
        ...
        type?: undefined;
        uid?: undefined;
    } & import("viem").ExactPartial<Pick<import("viem").PublicActions<import("viem").HttpTransport<undefined, false>, Chain, undefined>, "getChainId" | "prepareTransactionRequest" | "sendRawTransaction" | "call" | "createContractEventFilter" | "createEventFilter" | "estimateContractGas" | "estimateGas" | "getBlock" | "getBlockNumber" | "getContractEvents" | "getEnsText" | "getFilterChanges" | "getGasPrice" | "getLogs" | "getTransaction" | "getTransactionCount" | "getTransactionReceipt" | "readContract" | "simulateContract" | "uninstallFilter" | "watchBlockNumber" | "watchContractEvent"> & Pick<import("viem").WalletActions<Chain, undefined>, "sendTransaction" | "writeContract">>>(fn: (client: import("viem").Client<import("viem").HttpTransport<undefined, false>, Chain, undefined, import("viem").PublicRpcSchema, import("viem").PublicActions<import("viem").HttpTransport<undefined, false>, Chain>>) => client) => import("viem").Client<import("viem").HttpTransport<undefined, false>, Chain, undefined, import("viem").PublicRpcSchema, { [K in keyof client]: client[K]; } & import("viem").PublicActions<import("viem").HttpTransport<undefined, false>, Chain>>;
};
export declare function createDefaultPublicClients(chains: ChainConfig[]): Record<number, {
    account: undefined;
    batch?: {
        multicall?: boolean | import("viem").Prettify<import("viem").MulticallBatchOptions> | undefined;
    } | undefined;
...
export declare function createWebSocketClientFor(chain: ChainConfig): PublicClient;
export declare function createDefaultWebSocketClients(chains: ChainConfig[]): Record<number, PublicClient>;
/**
 ...
 */
export declare function createSetupConfig(config: SetupConfig): ResolvedSetupConfig;
export declare function findChainConfig(chainId: number, chains: ChainConfig[]): ChainConfig | undefined;
export declare function deriveNativeToken(chainId: number, chains: ChainConfig[]): TokenConfig | null;
