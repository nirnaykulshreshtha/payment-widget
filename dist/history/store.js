...
const STATUS_COPY = {
    initial: 'Payment initiated',
    approval_pending: 'Waiting for token approval',
    approval_confirmed: 'Token approval confirmed',
    swap_pending: 'Executing swap transaction',
    swap_confirmed: 'Swap transaction confirmed',
    wrap_pending: 'Waiting for wrap confirmation',
    wrap_confirmed: 'Wrap confirmed',
    deposit_pending: 'Waiting for deposit transaction',
    deposit_confirmed: 'Deposit confirmed',
    relay_pending: 'Waiting for relayer fill',
    relay_filled: 'Relayer filled deposit',
    settlement_pending: 'Awaiting settlement finality',
    settled: 'Payment settled',
    requested_slow_fill: 'Slow fill requested',
    slow_fill_ready: 'Slow fill completed',
    bridge_pending: 'Bridge pending',
    filled: 'Bridge filled',
    direct_pending: 'Payment pending',
    direct_confirmed: 'Payment confirmed',
